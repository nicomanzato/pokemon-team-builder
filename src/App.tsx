...
import { generateTeam, QUICK_PICKS } from './mock/generate'
...
export default function App() {
  ...
  async function build(q: string) {
    ...
    const { team, note } = await generateTeam(request, (step) =>
  ...
  return (
    <div className="mx-auto max-w-[1080px] px-5 pb-12 pt-6">
      ...
      <footer className="mt-12 border-t border-line pt-4 font-mono text-xs text-muted">
        Mock backend serving real teams generated by the v1 lab (7B + RAG). A local
        model plugs in here next.
      </footer>
    </div>
  )
}
